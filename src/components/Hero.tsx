  ...
  return (
    <section className="container grid lg:grid-cols-2 place-items-center py-20 md:py-32 gap-10">
      <div className="text-center lg:text-start space-y-6">
        ...
        A dynamic hub for tech enthusiasts in Colleges! Here, we come together to Connect ▸ Collaborate ▸ Code ▸ Create ▸ Conquer with global tech innovators through open-source projects, workshops, hackathons, and events.
        </p>
